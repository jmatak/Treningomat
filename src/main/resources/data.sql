...
INSERT INTO public.attendant (id, password, username, pid, id_photo, name, street_and_number, surname, city_id, comment_subscription) VALUES (5, '$2a$10$T8iVEwWTSmeWhokrNiGSR.MDHcLhueOMeZ4yvUZgkgFhIwrv5QDZ.', 'koMeneSlusa', 25489795634, 'attendant_koMeneSlusa.jpg', 'Miro', 'Oca Ante Gabrića 4', 'Bulj', 7, true);
INSERT INTO public.attendant (id, password, username, pid, id_photo, name, street_and_number, surname, city_id, comment_subscription) VALUES (4, '$2a$10$K69x73iMo5pl5EzOEK30cuQjWDAsJMyvamGeSAUts736MwVWwiy0m', 'jabbaTheHut', 455631587956, 'attendant_jabbaTheHut.jpg', 'Anka', 'Ul. kneza Mislava 8', 'Mrak-Taritaš', 1, true);
INSERT INTO public.attendant (id, password, username, pid, id_photo, name, street_and_number, surname, city_id, comment_subscription) VALUES (1, '$2a$10$zEvn1uNdUqyjyRRwr2Iup.wNUiVAsbojiNiC3oYiev4rMOE9a6TnG', 'plenki', 599542214894, 'attendant_plenki.jpg', 'Andrej', 'Trg svetog Marka 2', 'Plenković', 1, true);
INSERT INTO public.attendant (id, password, username, pid, id_photo, name, street_and_number, surname, city_id, comment_subscription) VALUES (3, '$2a$10$qDu00lEsP8FAkyyzfIuMBe4X9rcNClV4QwoJC7soTtx0gkFIMvwYS', 'gospodinDelozacija', 75862465894, 'attendant_gospodinDelozacija.jpg', 'Ivan', 'Pavlenski put 5G', 'Pernar', 1, true);
INSERT INTO public.attendant (id, password, username, pid, id_photo, name, street_and_number, surname, city_id, comment_subscription) VALUES (2, '$2a$10$NvCKZvl/5so8PIhTr0ZKsur4B438wcHwiuNm1hLJ2C7A6TAQ5xmF6', 'lordSDP', 49521468951, 'attendant_lordSDP.jpg', 'Davor', 'Trg Drage Iblera 9', 'Bernardić', 1, true);
